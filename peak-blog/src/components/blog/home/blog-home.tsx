    ...
    return (
        <div>
            <div className={"flex justify-center items-center flex-col divide-gray-50 border-b pt-12"}>
                ...
                <h2 className={"text-gray-500 font-light text-center leading-normal pb-12"}>{subdomain.description}</h2>
                <div className={"w-full flex items-center pb-4 text-gray-600"}>
                    <Link href={"/about-me"}>
                        <span className={"mr-5 cursor-pointer hover:text-blue-400"}>{author.given_name} {author.family_name}</span>
                    </Link>
